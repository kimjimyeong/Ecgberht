...
public class ChooseArmory extends Action {
    ...
    public State execute() {
        try {
            ...
            if (gameState.Fs.size() < gameState.getStrategyFromManager().getFacForArmory()) return State.FAILURE;
            if (Util.countUnitTypeSelf(UnitType.Terran_Armory) < gameState.getStrategyFromManager().getNumArmories()) {
