...
import ecgberht.Strategies.FullBioFE.FullBioFEBuilder;
...
public class FullMech extends Strategy {
    ...
    public static class FullMechBuilder{
  		...
  		public FullMechBuilder(String name, int armyForBay, int armyForTurret, int numBays, int raxPerCC, int facPerCC,
  		...
  		public FullMech build() {
  			return new FullMech(this);
  		}
      	
      }
  	private FullMech(FullMechBuilder builder) 
  	{
