...
import ecgberht.Strategies.BioMechGreedyFE.BioMechGreedyFEBuilder;
...
public class FastCC extends Strategy {
    ...
    public static class FastCCBuilder{
  		...
  		public FastCCBuilder(String name, int armyForBay, int armyForTurret, int numBays, int raxPerCC, int facPerCC,
  		...
  		public FastCC build() {
  			return new FastCC(this);
  		}
      	
      }
  	private FastCC(FastCCBuilder builder) 
  	{
