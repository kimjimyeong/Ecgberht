...
import ecgberht.Strategies.BioMechFE.BioMechFEBuilder;
...
public class BioMechGreedyFE extends Strategy {
    ...
    public static class BioMechGreedyFEBuilder{
		...
		public BioMechGreedyFEBuilder(String name, int armyForBay, int armyForTurret, int numBays, int raxPerCC, int facPerCC,
		...
		public BioMechGreedyFE build() {
			return new BioMechGreedyFE(this);
		}
    	
    }
	private BioMechGreedyFE(BioMechGreedyFEBuilder builder) 
	{
