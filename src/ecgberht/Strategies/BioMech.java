...
import ecgberht.Strategies.BioGreedyFE.BioGreedyFEBuilder;
...
public class BioMech extends Strategy {
    ...
    public static class BioMechBuilder{
		...
		public BioMechBuilder(String name, int armyForBay, int armyForTurret, int numBays, int raxPerCC, int facPerCC,
		...
		public BioMech build() {
			return new BioMech(this);
		}
    	
    }
	private BioMech(BioMechBuilder builder) 
	{
