...
import ecgberht.Strategies.ProxyBBS.ProxyBBSBuilder;
...
public class ProxyEightRax extends Strategy {
    ...
    public static class ProxyEightRaxBuilder{
    ...
    public ProxyEightRaxBuilder(String name, int armyForBay, int armyForTurret, int numBays, int raxPerCC, int facPerCC,
		...
		public ProxyEightRax build() {
			return new ProxyEightRax(this);
		}
		public ProxyEightRaxBuilder setProxy(boolean proxy) {
			this.proxy= proxy;
			return this;
		}
  	
    }
		private ProxyEightRax(ProxyEightRaxBuilder builder) 
	{
