...
import ecgberht.Strategies.TwoPortWraith.TwoPortWraithBuilder;
...
public class VultureRush extends Strategy {
    ...
    public static class VultureRushBuilder{
    ...
    public VultureRushBuilder(String name, int armyForBay, int armyForTurret, int numBays, int raxPerCC, int facPerCC,
		...
		public VultureRush build() {
			return new VultureRush(this);
		}
		public VultureRushBuilder setNumFacForPort(int numFacForPort) {
			this.numFacForPort = numFacForPort;
			return this;
		}
		public VultureRushBuilder setWorkerGas(int workerGas) {
			this.workerGas = workerGas;
			return this;
		}
  	
    }
		private VultureRush(VultureRushBuilder builder) 
	{
