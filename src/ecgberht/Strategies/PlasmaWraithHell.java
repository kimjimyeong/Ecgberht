...
import ecgberht.Strategies.MechGreedyFE.MechGreedyFEBuilder;
...
public class PlasmaWraithHell extends Strategy {
    ...
    public static class PlasmaWraithHellBuilder{
    ...
    public PlasmaWraithHellBuilder(String name, int armyForBay, int armyForTurret, int numBays, int raxPerCC, int facPerCC,
		...
		public PlasmaWraithHell build() {
			return new PlasmaWraithHell(this);
		}
		public PlasmaWraithHellBuilder setNumFacForPort(int numFacForPort) {
			this.numFacForPort = numFacForPort;
			return this;
		}
  	
    }
		private PlasmaWraithHell(PlasmaWraithHellBuilder builder) 
	{
