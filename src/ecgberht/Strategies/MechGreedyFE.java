...
public class MechGreedyFE extends Strategy {
    ...
    public static class MechGreedyFEBuilder{
  		...
  		public MechGreedyFEBuilder(String name, int armyForBay, int armyForTurret, int numBays, int raxPerCC, int facPerCC,
  		...
  		public MechGreedyFE build() {
  			return new MechGreedyFE(this);
  		}
      	
      }
  	private MechGreedyFE(MechGreedyFEBuilder builder) 
  	{
