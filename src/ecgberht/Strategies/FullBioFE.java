...
import ecgberht.Strategies.FullBio.FullBioBuilder;
...
public class FullBioFE extends Strategy {
    ...
    public static class FullBioFEBuilder{
  		...
  		public FullBioFEBuilder(String name, int armyForBay, int armyForTurret, int numBays, int raxPerCC, int facPerCC,
  		...
  		public FullBioFE build() {
  			return new FullBioFE(this);
  		}
      	
      }
  	private FullBioFE(FullBioFEBuilder builder) 
  	{
